...
try: 
    ...
    while(i):
        if(ak==len(l)):
            ...
            print("ADD "+str(akm[len(akm)-1])+' , '+str(akm[len(akm)-2]))
            akm.pop(len(akm)-2)
            #print(akm)
            print("STOR "+str(akm[len(akm)-1])+' , '+str(akm[0]))
            #print(ak)
            ...
            print("MOV "+str(l[ak+1])+' , '+str(r[li.index(l[ak+1])]))
            akm=akm+[r[li.index(l[ak+1])]]
            print("SUB "+str(akm[len(akm)-1])+' , '+str(akm[len(akm)-2]))
            akm.pop(len(akm)-2)
            print("STOR "+str(akm[len(akm)-1])+' , '+str(akm[0]))
            ak+=2
            ACounter+=2
            ...
            print("MOV "+str(l[ak+1])+' , '+str(r[li.index(l[ak+1])]))
            akm=akm+[r[li.index(l[ak+1])]]
            print("MUL "+str(akm[len(akm)-1])+' , '+str(akm[len(akm)-2]))
            akm.pop(len(akm)-2)
            print("STOR "+str(akm[len(akm)-1])+' , '+str(akm[0]))
            ak+=2
            ACounter+=2
            ...
            print("MOV "+str(l[ak+1])+' , '+str(r[li.index(l[ak+1])]))
            akm=akm+[r[li.index(l[ak+1])]]
            print("DIV "+str(akm[len(akm)-1])+' , '+str(akm[len(akm)-2]))
            akm.pop(len(akm)-2)
            print("STOR "+str(akm[len(akm)-1])+' , '+str(akm[0]))
            akm.clear()
            ak+=2
